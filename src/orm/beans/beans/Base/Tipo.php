 ...
 */
abstract class Tipo implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\beans\\beans\\Map\\TipoTableMap';
    ...
    /**
     * Initializes internal state of beans\beans\Base\Tipo object.
     */
    ...
    /**
     * Compares this with another <code>Tipo</code> instance.  If
     * <code>obj</code> is an instance of <code>Tipo</code>, delegates to
     * <code>equals(Tipo)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Tipo The current object, for fluid interface
     */
     ...
     * @return $this|\beans\beans\Tipo The current object (for fluent API support)
     */
    public function setIdtipo($v)
    {
        ...
        if ($this->idtipo !== $v) {
            $this->idtipo = $v;
            $this->modifiedColumns[TipoTableMap::COL_IDTIPO] = true;
        }
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[TipoTableMap::COL_NOMBRE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TipoTableMap::translateFieldName('Idtipo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idtipo = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TipoTableMap::translateFieldName('Nombre', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\beans\\beans\\Tipo'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTipoQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTipoQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TipoTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TipoTableMap::COL_IDTIPO)) {
            $modifiedColumns[':p' . $index++]  = 'idtipo';
        }
        if ($this->isColumnModified(TipoTableMap::COL_NOMBRE)) {
    ...
    {
        $pos = TipoTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Tipo'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Tipo'][$this->hashCode()] = true;
        $keys = TipoTableMap::getFieldNames($keyType);
        $result = array(
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\beans\beans\Tipo The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TipoTableMap::COL_IDTIPO)) {
            $criteria->add(TipoTableMap::COL_IDTIPO, $this->idtipo);
        }
        if ($this->isColumnModified(TipoTableMap::COL_NOMBRE)) {
            $criteria->add(TipoTableMap::COL_NOMBRE, $this->nombre);
        }
    ...
    {
        $criteria = ChildTipoQuery::create();
        $criteria->add(TipoTableMap::COL_IDTIPO, $this->idtipo);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \beans\beans\Tipo (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \beans\beans\Tipo Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildTipo is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTipo The current object (for fluent API support)
     */
    ...
    {
        return (string) $this->exportTo(TipoTableMap::DEFAULT_STRING_FORMAT);
    }
