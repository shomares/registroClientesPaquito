 ...
 *
 *
 * @method     ChildPaisQuery orderByIdpais($order = Criteria::ASC) Order by the idPais column
 * @method     ChildPaisQuery orderByNombre($order = Criteria::ASC) Order by the nombre column
 *
 * @method     ChildPaisQuery groupByIdpais() Group by the idPais column
 * @method     ChildPaisQuery groupByNombre() Group by the nombre column
 *
 ...
 *
 * @method     ChildPaisQuery leftJoinEstado($relationAlias = null) Adds a LEFT JOIN clause to the query using the Estado relation
 * @method     ChildPaisQuery rightJoinEstado($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Estado relation
 * @method     ChildPaisQuery innerJoinEstado($relationAlias = null) Adds a INNER JOIN clause to the query using the Estado relation
 *
 * @method     ChildPaisQuery joinWithEstado($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Estado relation
 *
 * @method     ChildPaisQuery leftJoinWithEstado() Adds a LEFT JOIN clause and with to the query using the Estado relation
 * @method     ChildPaisQuery rightJoinWithEstado() Adds a RIGHT JOIN clause and with to the query using the Estado relation
 * @method     ChildPaisQuery innerJoinWithEstado() Adds a INNER JOIN clause and with to the query using the Estado relation
 *
 * @method     \beans\beans\EstadoQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildPais findOneByIdpais(int $idPais) Return the first ChildPais filtered by the idPais column
 * @method     ChildPais findOneByNombre(string $nombre) Return the first ChildPais filtered by the nombre column *
 ...
 *
 * @method     ChildPais requireOneByIdpais(int $idPais) Return the first ChildPais filtered by the idPais column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildPais requireOneByNombre(string $nombre) Return the first ChildPais filtered by the nombre column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildPais[]|ObjectCollection findByIdpais(int $idPais) Return ChildPais objects filtered by the idPais column
 * @method     ChildPais[]|ObjectCollection findByNombre(string $nombre) Return ChildPais objects filtered by the nombre column
...
abstract class PaisQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \beans\beans\Base\PaisQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\beans\\beans\\Pais', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT idPais, nombre FROM pais WHERE idPais = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(PaisTableMap::COL_IDPAIS, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(PaisTableMap::COL_IDPAIS, $keys, Criteria::IN);
    }

    /**
     * Filter the query on the idPais column
     *
     * Example usage:
     * <code>
     * $query->filterByIdpais(1234); // WHERE idPais = 1234
     * $query->filterByIdpais(array(12, 34)); // WHERE idPais IN (12, 34)
     * $query->filterByIdpais(array('min' => 12)); // WHERE idPais > 12
     * </code>
     *
    ...
    public function filterByIdpais($idpais = null, $comparison = null)
    {
        if (is_array($idpais)) {
            $useMinMax = false;
            if (isset($idpais['min'])) {
                $this->addUsingAlias(PaisTableMap::COL_IDPAIS, $idpais['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idpais['max'])) {
                $this->addUsingAlias(PaisTableMap::COL_IDPAIS, $idpais['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PaisTableMap::COL_IDPAIS, $idpais, $comparison);
    }
    ...
    public function filterByNombre($nombre = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PaisTableMap::COL_NOMBRE, $nombre, $comparison);
    }

    /**
     * Filter the query by a related \beans\beans\Estado object
     *
     * @param \beans\beans\Estado|ObjectCollection $estado the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    public function filterByEstado($estado, $comparison = null)
    {
        if ($estado instanceof \beans\beans\Estado) {
            return $this
                ->addUsingAlias(PaisTableMap::COL_IDPAIS, $estado->getPaisIdpais(), $comparison);
    ...
    {
        if ($pais) {
            $this->addUsingAlias(PaisTableMap::COL_IDPAIS, $pais->getIdpais(), Criteria::NOT_EQUAL);
        }
