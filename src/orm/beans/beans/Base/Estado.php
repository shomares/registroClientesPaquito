 ...
 */
abstract class Estado implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\beans\\beans\\Map\\EstadoTableMap';
    ...
    /**
     * The value for the idestado field.
     *
     * @var        int
     */
    protected $idestado;
    ...
    /**
     * The value for the pais_idpais field.
     *
     * @var        int
     */
    ...
    /**
     * Initializes internal state of beans\beans\Base\Estado object.
     */
    ...
    /**
     * Compares this with another <code>Estado</code> instance.  If
     * <code>obj</code> is an instance of <code>Estado</code>, delegates to
     * <code>equals(Estado)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Estado The current object, for fluid interface
     */
    ...
    /**
     * Get the [pais_idpais] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [idestado] column.
     *
     * @param int $v new value
     * @return $this|\beans\beans\Estado The current object (for fluent API support)
     */
    public function setIdestado($v)
    {
        ...
        if ($this->idestado !== $v) {
            $this->idestado = $v;
            $this->modifiedColumns[EstadoTableMap::COL_IDESTADO] = true;
        }
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[EstadoTableMap::COL_NOMBRE] = true;
        }
    ...
    /**
     * Set the value of [pais_idpais] column.
     *
     * @param int $v new value
     * @return $this|\beans\beans\Estado The current object (for fluent API support)
     */
    public function setPaisIdpais($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->pais_idpais !== $v) {
            $this->pais_idpais = $v;
            $this->modifiedColumns[EstadoTableMap::COL_PAIS_IDPAIS] = true;
        }

        if ($this->aPais !== null && $this->aPais->getIdpais() !== $v) {
            $this->aPais = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EstadoTableMap::translateFieldName('Idestado', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idestado = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EstadoTableMap::translateFieldName('Nombre', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nombre = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EstadoTableMap::translateFieldName('PaisIdpais', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pais_idpais = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\beans\\beans\\Estado'), 0, $e);
        }
    }
    ...
    {
        if ($this->aPais !== null && $this->pais_idpais !== $this->aPais->getIdpais()) {
            $this->aPais = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildEstadoQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Estado::setDeleted()
     * @see Estado::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEstadoQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EstadoTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->direccionsScheduledForDeletion !== null) {
                if (!$this->direccionsScheduledForDeletion->isEmpty()) {
                    \beans\beans\DireccionQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[EstadoTableMap::COL_IDESTADO] = true;
        if (null !== $this->idestado) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . EstadoTableMap::COL_IDESTADO . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(EstadoTableMap::COL_IDESTADO)) {
            $modifiedColumns[':p' . $index++]  = 'idEstado';
        }
        if ($this->isColumnModified(EstadoTableMap::COL_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = 'nombre';
        }
        if ($this->isColumnModified(EstadoTableMap::COL_PAIS_IDPAIS)) {
            $modifiedColumns[':p' . $index++]  = 'Pais_idPais';
        }
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'idEstado':
                        $stmt->bindValue($identifier, $this->idestado, PDO::PARAM_INT);
                        break;
                    case 'nombre':
                        $stmt->bindValue($identifier, $this->nombre, PDO::PARAM_STR);
                        break;
                    case 'Pais_idPais':
                        $stmt->bindValue($identifier, $this->pais_idpais, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = EstadoTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Estado'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Estado'][$this->hashCode()] = true;
        $keys = EstadoTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdestado(),
            $keys[1] => $this->getNombre(),
            $keys[2] => $this->getPaisIdpais(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\beans\beans\Estado
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdestado($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setNombre($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setPaisIdpais($arr[$keys[2]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\beans\beans\Estado The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(EstadoTableMap::DATABASE_NAME);

        if ($this->isColumnModified(EstadoTableMap::COL_IDESTADO)) {
            $criteria->add(EstadoTableMap::COL_IDESTADO, $this->idestado);
        }
        if ($this->isColumnModified(EstadoTableMap::COL_NOMBRE)) {
            $criteria->add(EstadoTableMap::COL_NOMBRE, $this->nombre);
        }
        if ($this->isColumnModified(EstadoTableMap::COL_PAIS_IDPAIS)) {
            $criteria->add(EstadoTableMap::COL_PAIS_IDPAIS, $this->pais_idpais);
        }
    ...
    {
        $criteria = ChildEstadoQuery::create();
        $criteria->add(EstadoTableMap::COL_IDESTADO, $this->idestado);
    ...
    /**
     * Generic method to set the primary key (idestado column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \beans\beans\Estado (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setPaisIdpais($this->getPaisIdpais());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \beans\beans\Estado Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($v === null) {
            $this->setPaisIdpais(NULL);
        } else {
            $this->setPaisIdpais($v->getIdpais());
        }
    ...
    {
        if ($this->aPais === null && ($this->pais_idpais !== null)) {
            $this->aPais = ChildPaisQuery::create()->findPk($this->pais_idpais, $con);
    ...
    public function initDireccions($overrideExisting = true)
    {
        ...
        $this->collDireccions->setModel('\beans\beans\Direccion');
    }
     ...
     * If this ChildEstado is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildEstado The current object (for fluent API support)
     */
    public function setDireccions(Collection $direccions, ConnectionInterface $con = null)
    {
        ...
        foreach ($direccionsToDelete as $direccionRemoved) {
            $direccionRemoved->setEstado(null);
        }
    ...
    {
        if (null !== $this->aPais) {
            $this->aPais->removeEstado($this);
        }
        $this->idestado = null;
        $this->nombre = null;
        $this->pais_idpais = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
        $this->resetModified();
        $this->setNew(true);
    ...
    {
        return (string) $this->exportTo(EstadoTableMap::DEFAULT_STRING_FORMAT);
    }
