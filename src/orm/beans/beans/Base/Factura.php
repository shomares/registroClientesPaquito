 ...
 */
abstract class Factura implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\beans\\beans\\Map\\FacturaTableMap';
    ...
    /**
     * The value for the nocuenta field.
     *
     * @var        string
     */
    protected $nocuenta;
    ...
    /**
     * Initializes internal state of beans\beans\Base\Factura object.
     */
    ...
    /**
     * Compares this with another <code>Factura</code> instance.  If
     * <code>obj</code> is an instance of <code>Factura</code>, delegates to
     * <code>equals(Factura)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Factura The current object, for fluid interface
     */
     ...
     * @return $this|\beans\beans\Factura The current object (for fluent API support)
     */
    public function setIdfactura($v)
    {
        ...
        if ($this->idfactura !== $v) {
            $this->idfactura = $v;
            $this->modifiedColumns[FacturaTableMap::COL_IDFACTURA] = true;
        }
    ...
    public function setRfc($v)
    {
        ...
        if ($this->rfc !== $v) {
            $this->rfc = $v;
            $this->modifiedColumns[FacturaTableMap::COL_RFC] = true;
        }
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[FacturaTableMap::COL_NOMBRE] = true;
        }
    ...
    public function setApellidopaterno($v)
    {
        ...
        if ($this->apellidopaterno !== $v) {
            ...
            $this->modifiedColumns[FacturaTableMap::COL_APELLIDOPATERNO] = true;
        }
    ...
    public function setApellidomaterno($v)
    {
        ...
        if ($this->apellidomaterno !== $v) {
            ...
            $this->modifiedColumns[FacturaTableMap::COL_APELLIDOMATERNO] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[FacturaTableMap::COL_EMAIL] = true;
        }
    ...
    /**
     * Set the value of [nocuenta] column.
     *
     * @param string $v new value
     * @return $this|\beans\beans\Factura The current object (for fluent API support)
     */
    public function setNocuenta($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->nocuenta !== $v) {
            $this->nocuenta = $v;
            $this->modifiedColumns[FacturaTableMap::COL_NOCUENTA] = true;
        }
    ...
    public function setTelefono($v)
    {
        ...
        if ($this->telefono !== $v) {
            $this->telefono = $v;
            $this->modifiedColumns[FacturaTableMap::COL_TELEFONO] = true;
        }
    ...
    public function setDireccionIddireccion($v)
    {
        ...
        if ($this->direccion_iddireccion !== $v) {
            ...
            $this->modifiedColumns[FacturaTableMap::COL_DIRECCION_IDDIRECCION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : FacturaTableMap::translateFieldName('Idfactura', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idfactura = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : FacturaTableMap::translateFieldName('Rfc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rfc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : FacturaTableMap::translateFieldName('Nombre', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nombre = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : FacturaTableMap::translateFieldName('Apellidopaterno', TableMap::TYPE_PHPNAME, $indexType)];
            $this->apellidopaterno = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : FacturaTableMap::translateFieldName('Apellidomaterno', TableMap::TYPE_PHPNAME, $indexType)];
            $this->apellidomaterno = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : FacturaTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : FacturaTableMap::translateFieldName('Nocuenta', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nocuenta = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : FacturaTableMap::translateFieldName('Telefono', TableMap::TYPE_PHPNAME, $indexType)];
            $this->telefono = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : FacturaTableMap::translateFieldName('DireccionIddireccion', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 9; // 9 = FacturaTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\beans\\beans\\Factura'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildFacturaQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Factura::setDeleted()
     * @see Factura::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildFacturaQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FacturaTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(FacturaTableMap::COL_IDFACTURA)) {
            $modifiedColumns[':p' . $index++]  = 'idfactura';
        }
        if ($this->isColumnModified(FacturaTableMap::COL_RFC)) {
            $modifiedColumns[':p' . $index++]  = 'rfc';
        }
        if ($this->isColumnModified(FacturaTableMap::COL_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = 'nombre';
        }
        if ($this->isColumnModified(FacturaTableMap::COL_APELLIDOPATERNO)) {
            $modifiedColumns[':p' . $index++]  = 'apellidoPaterno';
        }
        if ($this->isColumnModified(FacturaTableMap::COL_APELLIDOMATERNO)) {
            $modifiedColumns[':p' . $index++]  = 'apellidoMaterno';
        }
        if ($this->isColumnModified(FacturaTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'email';
        }
        if ($this->isColumnModified(FacturaTableMap::COL_NOCUENTA)) {
            $modifiedColumns[':p' . $index++]  = 'noCuenta';
        }
        if ($this->isColumnModified(FacturaTableMap::COL_TELEFONO)) {
            $modifiedColumns[':p' . $index++]  = 'telefono';
        }
        if ($this->isColumnModified(FacturaTableMap::COL_DIRECCION_IDDIRECCION)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'email':
                        ...
                        break;
                    case 'noCuenta':
                        $stmt->bindValue($identifier, $this->nocuenta, PDO::PARAM_STR);
                        break;
                    case 'telefono':
    ...
    {
        $pos = FacturaTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Factura'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Factura'][$this->hashCode()] = true;
        $keys = FacturaTableMap::getFieldNames($keyType);
        $result = array(
            ...
            $keys[6] => $this->getNocuenta(),
            $keys[7] => $this->getTelefono(),
            $keys[8] => $this->getDireccionIddireccion(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\beans\beans\Factura
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdfactura($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setRfc($arr[$keys[1]]);
        }
        ...
        if (array_key_exists($keys[6], $arr)) {
            $this->setNocuenta($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setTelefono($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setDireccionIddireccion($arr[$keys[8]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\beans\beans\Factura The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FacturaTableMap::COL_IDFACTURA)) {
            $criteria->add(FacturaTableMap::COL_IDFACTURA, $this->idfactura);
        }
        if ($this->isColumnModified(FacturaTableMap::COL_RFC)) {
            $criteria->add(FacturaTableMap::COL_RFC, $this->rfc);
        }
        if ($this->isColumnModified(FacturaTableMap::COL_NOMBRE)) {
            $criteria->add(FacturaTableMap::COL_NOMBRE, $this->nombre);
        }
        if ($this->isColumnModified(FacturaTableMap::COL_APELLIDOPATERNO)) {
            $criteria->add(FacturaTableMap::COL_APELLIDOPATERNO, $this->apellidopaterno);
        }
        if ($this->isColumnModified(FacturaTableMap::COL_APELLIDOMATERNO)) {
            $criteria->add(FacturaTableMap::COL_APELLIDOMATERNO, $this->apellidomaterno);
        }
        if ($this->isColumnModified(FacturaTableMap::COL_EMAIL)) {
            $criteria->add(FacturaTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(FacturaTableMap::COL_NOCUENTA)) {
            $criteria->add(FacturaTableMap::COL_NOCUENTA, $this->nocuenta);
        }
        if ($this->isColumnModified(FacturaTableMap::COL_TELEFONO)) {
            $criteria->add(FacturaTableMap::COL_TELEFONO, $this->telefono);
        }
        if ($this->isColumnModified(FacturaTableMap::COL_DIRECCION_IDDIRECCION)) {
            $criteria->add(FacturaTableMap::COL_DIRECCION_IDDIRECCION, $this->direccion_iddireccion);
        }
    ...
    {
        $criteria = ChildFacturaQuery::create();
        $criteria->add(FacturaTableMap::COL_IDFACTURA, $this->idfactura);
    ...
    {
        $validPk = null !== $this->getIdfactura();
     ...
     * objects.
     *
     * @param      object $copyObj An object of \beans\beans\Factura (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setNocuenta($this->getNocuenta());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \beans\beans\Factura Clone of current object.
     * @throws PropelException
     */
    ...
    public function getDireccion(ConnectionInterface $con = null)
    {
        if ($this->aDireccion === null && ($this->direccion_iddireccion !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aDireccion->addFacturas($this);
             */
        }
     ...
     * If this ChildFactura is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildFactura The current object (for fluent API support)
     */
    public function setClientes(Collection $clientes, ConnectionInterface $con = null)
    {
        ...
        foreach ($clientesToDelete as $clienteRemoved) {
            $clienteRemoved->setFactura(null);
        }
    ...
    {
        if (null !== $this->aDireccion) {
            $this->aDireccion->removeFactura($this);
        }
        $this->idfactura = null;
        $this->rfc = null;
        $this->nombre = null;
    ...
    {
        return (string) $this->exportTo(FacturaTableMap::DEFAULT_STRING_FORMAT);
    }
